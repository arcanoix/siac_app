...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_home_vue__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_login_vue__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__auth_js__ = __webpack_require__(34);
...
router.beforeEach(function (to, from, next) {
	if (to.meta.requiresAuth) {
		if (__WEBPACK_IMPORTED_MODULE_5__auth_js__["a" /* default */].isLogin()) {
			next();
		} else {
			next({
				path: '/login'
