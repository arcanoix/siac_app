            ...
            <div class="box">
                <div class="col-md-12">
                    <div class="box-header with-border">
                        <h1 class="box-title">Clientes CANTV</h1>
                        <div class="box-body">
                            @if (!$clientes->isEmpty())
                                <table class="table table-bordered">
                                  ...
                                  <tbody>
                                      @foreach ($clientes as $deliveryReport)
                                        <tr>
                                          <td>{{ $deliveryReport->id }}</td>
                                          <td>{{ $deliveryReport->name }}</td>
                                          <td>{{ $deliveryReport->last_name }}</td>
                                          <td>{{ $deliveryReport->identification_card }}</td>
                                          <td>{{ $deliveryReport->address }}</td>
